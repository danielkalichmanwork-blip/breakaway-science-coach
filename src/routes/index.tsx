    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <style>{`
        :root {
          ...
          --ring: ${LOGO_GREEN_HSL} !important;
        }
        .bg-primary { background-color: ${LOGO_GREEN_HEX} !important; }
        .text-primary { color: ${LOGO_GREEN_HEX} !important; }
        .border-primary { border-color: ${LOGO_GREEN_HEX} !important; }
        .border-t-2.border-primary { border-top-color: ${LOGO_GREEN_HEX} !important; }
        .glow-primary { box-shadow: 0 0 30px -5px ${LOGO_GREEN_HEX}66 !important; }
      `}</style>
      ...
      <header className="sticky top-0 z-50 border-b border-border bg-background/80 backdrop-blur">
        <nav className="mx-auto flex max-w-6xl items-center justify-between px-5 py-4">
          ...
          <a href="#contact" className="inline-flex items-center gap-1.5 rounded-sm bg-primary px-4 py-2 text-sm font-semibold text-black transition-opacity hover:opacity-90">Start coaching <ArrowUpRight className="size-4" /></a>
        </nav>
      </header>
      ...
      <section id="top" className="relative flex min-h-[92vh] items-end overflow-hidden">
        ...
        <div className="relative mx-auto w-full max-w-6xl px-5 pb-20 pt-32">
          ...
          <div className="mt-9 flex flex-wrap items-center gap-3">
            <a href="#contact" className="inline-flex items-center gap-2 rounded-sm bg-primary px-6 py-3 font-semibold text-black transition-opacity hover:opacity-90 glow-primary">Book a free consultation <ArrowUpRight className="size-4" /></a>
        ...
        <div className="mx-auto grid max-w-6xl gap-14 px-5 lg:grid-cols-[1fr_0.85fr]">
          <div>
            ...
            <div className="mt-6 space-y-4 leading-relaxed text-muted-foreground">
              <p>I am a former professional cyclist who has raced for some of the top teams in North America. I began my cycling career late, starting at age 23 while in university, but quickly made significant progress.</p>
              <p>I understand the importance of balance; I trained, raced, and travelled while completing seven years of post-secondary education. Time management is key to success both as an athlete and in personal life.</p>
              <p>As a marginal gains fanatic and early adopter, I have researched various claims and identified what truly works. I apply these insights to my coaching, ensuring everything an athlete does on or off the bike has purpose.</p>
              <p>The Breakaway Method emphasizes the use of data—including power output, heart rate, race analysis, training load, heart rate variability (HRV), lactate threshold, and aerodynamics (CdA)—to make informed training decisions without unnecessary complexity. I work with athletes across a range of disciplines and goals, including road racing, fondos, crit racing, gravel, time trials, track cycling, and general fitness.</p>
              <p>Based in Toronto, Ontario, I help cyclists improve their performance, better understand their training and data, and make the most of the time they have on the bike. Whether you're preparing for your first race or chasing a personal best, the Breakaway Method is about making every part of your training purposeful. To learn more about personalized cycling coaching, please reach out at <a href="mailto:breakawaymethod@gmail.com" className="font-semibold text-primary underline underline-offset-4 hover:text-primary/80">breakawaymethod@gmail.com</a></p>
            </div>
          </div>
          <div className="rounded-sm border border-border bg-card p-8">
            <h3 className="text-lg uppercase">Coaching focus</h3>
            <ul className="mt-5 space-y-3 text-sm">
              {["Road, criterium and gravel racing", "Time trial power and position optimisation", "Track endurance and pursuit pacing", "Gran fondo and long-distance events", "Return to structure after a layoff"].map((f) => (
                <li key={f} className="flex items-start gap-2"><Check className="mt-0.5 size-4 shrink-0 text-primary" /><span className="text-muted-foreground">{f}</span></li>
              ))}
            </ul>
            <div className="mt-8 border-t border-border pt-6">
              ...
              <a href="https://www.ftcycling.ca/" target="_blank" rel="noopener noreferrer" className="mt-4 inline-flex items-center gap-1.5 text-sm font-semibold text-primary hover:underline">FT Cycling bike fitting <ArrowUpRight className="size-4" /></a>
            </div>
          </div>
        </div>
      </section>
